...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1N5Nx7WEUcJpDRfzcGBhFAaQtXFBzLUW1d7sZ689H5r8/edit?usp=sharing) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denklemim **-1,26*t^2 + 1.84*t + -1.42E-03**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif? **Cisim yavaşladığı için a katsayısının negatif bir değer olduğunu düşünüyorum.**

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? **Hayır** 

c) Video'daki cismin atılış hızı farklı olsaydı (diğer her şey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) **Bence a ve b değişecekti**
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1WIp_wY6AC6wgw2X3Bue16Tb8uMZjQg2A07rHdwrBMdI/edit?usp=sharing) link veriniz.
...
**Benim ölçümüme göre konumsal olarak 0,75 cm'lik bir hatanız, zamansal olarak ise 33 milisaniyelik bir hatanız var.**
2) Acaba hiç grafik çizmeden sürtünme katsayısını bulabilir miydim?  (Cevap: Evet). 
Yardım:
* Düzgün ivmelenen bir cisim için alınan yol formülü x = (ilk hız+ son hız)/2*t, burdan cismin ilk hızını bulunuz. **"0,675 = (V1+0)/2" Bu denklemi çözersek 1,35=V1 çıkar...** 
* Daha sonra iş-kinetik enerji teorimini kullanarak sürtünme kuvvetini bulun. Sürtünme kuvvetinden, kinetik sürtünme katsayısını bulunuz. **"1,35^2*1*1/2"den 0.91125 buldum. 0.91125=0.675*F ve buradan da yine 1.35 sonucunu aldım(?)**
